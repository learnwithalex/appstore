...
export default function AppRelated() {
  const list = [
    {
      title: "X",
  ...
  return (
    <div className="mt-5">
     <Link isBlock showAnchorIcon href="/apps/related/spotify" size="lg" className="font-bold ml-3" color="foreground">
        Related Apps
      </Link>
    <div className="gap-2 grid grid-cols-3 sm:grid-cols-3 p-4">
      {list.map((item, index) => (
